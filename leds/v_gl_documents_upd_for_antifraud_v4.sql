CREATE OR REPLACE VIEW ANTIFRAUD.v_gl_documents_upd_for_antifraud as 
...
c.cl_acc as payer_account, /*Плательщик. Номер счета*/
...
c.co_acc as receiver_account, /*Получатель. Номер счета*/
...
JOIN ibs.gl_documents l on l.lead_id = c.id
